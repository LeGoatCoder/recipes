...
<p><em>We are working on an article that will guide you on how to create your own model and upload it to Hugging Face.</em></p>
...
<!--- TODO: add a note about this article not being a hands-on tutorial --->
<p><strong>Note:</strong> This article is not meant as a hands-on tutorial. For more detailed instructions please check the [documentation](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-huggingface).</p>

The overall process to use a Hugging Face module with Weav
