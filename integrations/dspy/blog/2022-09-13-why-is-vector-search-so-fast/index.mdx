---
title: Why is Vector Search so fast?  # Title of the blog post
slug: why-is-vector-search-so-fast  # Slug for the URL
authors: [laura]  # Author of the blog post
date: 2022-09-13  # Date of publication
tags: ['search']  # Tags for the blog post
image: ./img/hero.png  # Image for the blog post
description: "Vector Databases can run semantic queries on multi-million datasets in milliseconds. How is that possible?"  # Description of the blog post
---
