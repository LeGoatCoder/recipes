...
# 
# For example, when you import data into Weaviate, Weaviate will automatically extract the relevant text fields,
# send them Hugging Face to vectorize, and store the data with the new vectors in the database.
# 
...
# You don't need to update any configs or anything, it is there ready and waiting.
# 
