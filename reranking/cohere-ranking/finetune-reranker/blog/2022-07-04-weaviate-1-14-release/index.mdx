...
Weaviate 1.14 is here, and it's packed with improvements and features that make it the most reliable and observable Weaviate release yet! This release includes:

- **Reliability fixes and improvements** to ensure Weaviate runs smoothly and without issues.
- **Monitoring and Observability** to help you understand what's happening under the hood.
- **Support for non-cosine distances** to expand the range of use cases Weaviate can handle.
- **API changes** to improve the way you interact with Weaviate.

## 🔧 Reliability fixes and improvements

At Weaviate, reliability is one of our core values. We strive to make our software dependable, bug-free, and behaving as expected. This release includes over 25 bug fixes and reliability improvements. Here are some highlights:

### 🐛 Critical bug fix in compaction logic

We fixed a critical bug that, in rare situations, could result in data loss. This bug affected environments with frequent updates and deletes.
...
These are just a few of the many improvements and bug fixes that were included in this release. Check out [the changelog](https://github.com/weaviate/weaviate/releases/tag
